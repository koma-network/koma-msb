...
public class MsbPubsubnodeSearchBean {
	...
	private java.util.List<MsbPubsubnodeBean> msbPubsubnode;
	...
	public java.util.List<MsbPubsubnodeBean> getMsbPubsubnode() {
    	return this.msbPubsubnode;
	}
  
	public void setMsbPubsubnode(java.util.List<MsbPubsubnodeBean> msbPubsubnode) {
    	this.msbPubsubnode = msbPubsubnode;
	}
