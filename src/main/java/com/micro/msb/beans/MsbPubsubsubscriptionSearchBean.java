...
public class MsbPubsubsubscriptionSearchBean {
	...
	private java.util.List<MsbPubsubsubscriptionBean> msbPubsubsubscription;
	...
	public java.util.List<MsbPubsubsubscriptionBean> getMsbPubsubsubscription() {
    	return this.msbPubsubsubscription;
	}
  
	public void setMsbPubsubsubscription(java.util.List<MsbPubsubsubscriptionBean> msbPubsubsubscription) {
    	this.msbPubsubsubscription = msbPubsubsubscription;
	}
